...
p. All the standard Play annotations can work with Hazelcast instead of EhCache or Memcached, just add this line in *application.conf*:

bc. cache.class=play.cache.HazelcastCacheImpl
...
p. Hazelcast give you access to a number of clustered services
...
You can modify *hazelcast.xml* to your need to create more Queues or Map and modify the default ExecutorService parameters.
